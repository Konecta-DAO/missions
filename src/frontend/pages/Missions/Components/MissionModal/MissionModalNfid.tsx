...
const MissionModal: React.FC<MissionModalProps> = ({ closeModal, selectedMissionId }) => {
    ...
    const mission = useMemo(() => {
        return globalID.missionsnfid?.find((m: { id: bigint }) => m.id === selectedMissionId);
    }, [globalID.missionsnfid, selectedMissionId]);
    ...
    const missionCompleted = useMemo(() => checkMissionCompletionNfid(globalID.userProgressnfid, mission), [globalID.userProgressnfid, missionId]);
