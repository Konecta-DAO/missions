...
import styles from './HomeBackgroundOverlayTablet.module.scss';

const HomeBackgroundOverlayTablet: React.FC = () => {
    return (
        <div className={styles.svgContainer}>
            ...
            >
                ...
                <>
                    ...
                    <path id="Cir3-Tablet" className={styles.st1} d="M1479.9,3296.3l-239-240v-597.4c66.3-13.2,116.4-71.7,116.4-141.9c0-79.9-64.8-144.7-144.7-144.7
                    ...
                    <polygon id="Cir4-Tablet" className={styles.st1} points="1915.7,4029.5 1855.7,4029.5 1855.7,3309.8 1649.1,3103.1 1433.7,2887.7 1424.9,2878.9 
					1424.9,2866.5 1424.9,-30 1484.9,-30 1484.9,2854.1 1691.5,3060.7 1906.9,3276.1 1915.7,3284.9 1915.7,3297.3 				"/>

                    <path id="Cir5-Tablet" className={styles.st1} d="M1946.2,2685.3v-645.9l395.6-398.9l-42.4-42.8L1895,2005.6l-8.8,8.9v670.7
                    ...
                    <path id="Linea3-Tablet" className={styles.st2} d="M1214.4,2456.8c0,204.4,0,408.8,0,613.3c81.2,81.2,162.5,162.5,243.7,243.7
		c0,175.4,0,350.8,0,526.2"/>
                    <path id="Linea4-Tablet" className={styles.st2} d="M1457.5,0c0,954.6,0,1909.2,0,2863.8c142.5,142.5,285,285,427.5,427.5c0,182.9,0,365.8,0,548.7" />
                    <path id="Linea5-Tablet" className={styles.st2} d="M2160,1782.2c-81.2,81.2-162.4,162.4-243.6,243.6c0,221.1,0,442.2,0,663.3" />


                    <circle r="60" className={styles.movingLight}>
                        <animateMotion repeatCount="indefinite" dur="5s">
                            <mpath href="#Linea1-Tablet" />
                        </animateMotion>
                    </circle>
...
export default HomeBackgroundOverlayTablet;
