        ...
        <div className={styles.svgContainer}>
            ...
            >
                ...
                <>
                    ...
                    <path id="Linea1-tablet" className={styles.st2} d="M0,1862.3c187.6,187.6,375.2,375.2,562.8,562.8c0,422,0,844,0,1266 c-49.5,49.5-98.9,98.9-148.4,148.4" />
                    <path id="Linea2-tablet" className={styles.st2} d="M0,723c191.7,0,383.4,0,575.1,0c117.2,117.2,234.4,234.4,351.5,351.5c0,921.8,0,1843.6,0,2765.5" />
                    <path id="Linea3-tablet" className={styles.st2} d="M1214.4,2456.8c0,204.4,0,408.8,0,613.3c81.2,81.2,162.5,162.5,243.7,243.7 c0,175.4,0,350.8,0,526.2" />
